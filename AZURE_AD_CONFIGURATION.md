...
6. Selecciona **Single-page application (SPA)** o **Web** según tu configuración
7. Agrega las siguientes Redirect URIs:
   - `https://UGM-proctoring.replit.app/auth/callback`
   - `https://6b145858-516c-4253-bbb2-6042ec3593fe-00-3el5cnkqxkgt7.janeway.replit.dev/auth/callback`
   - `http://localhost:5000/auth/callback`
...
- Verifica que la URI en Azure AD coincida exactamente con la que está en `msal-config.ts`
