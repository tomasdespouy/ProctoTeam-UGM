...
import { HelpCircle, Sparkles, Send, Loader2 } from 'lucide-react';
import { askStudentHelp } from '@/ai/flows/student-help-flow';
import { ThemeToggle } from '@/components/theme-toggle';
import { useRouter } from 'next/navigation';
import { useAuth } from '@/context/auth-context';
import { LogOut, GraduationCap, History, BookOpen } from 'lucide-react';
...
export default function StudentHelpPage() {
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    setAiResponse(null);
    try {
      const result = await askStudentHelp({ query: values.query });
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-6">
              <div className="flex items-center gap-4">
                <Button variant="ghost" className="p-0 h-auto w-auto" onClick={() => router.push('/student')}>
                  <Image
                    src="/Logo lineas.png"
      ...
      <main className="flex-1 bg-gray-100 dark:bg-gray-900 p-8">
        ...
        <div className="mb-8">
          <h1 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">
            Asistente de IA para Estudiantes
          </h1>
